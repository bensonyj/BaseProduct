...
//    }
    ...
    for (NSString *pinyin in A_Result) {
        if ([pinyin isEqualToString:@"#"]) {
            [A_Result removeObject:pinyin];
            [A_Result addObject:@"#"];
            break;
        }
    }
...
//    }
    ...
    for (NSString *pinyin in A_Result) {
        if ([pinyin isEqualToString:@"#"]) {
            NSArray *firstArray = [LetterResult firstObject];
            [LetterResult removeObject:firstArray];
            [LetterResult addObject:firstArray];
            break;
        }
    }
...
//        chineseString.string = [NSString stringWithString:[stringArr objectAtIndex:i]];
        ChineseString *chineseString = (ChineseString *)stringArr[i];
