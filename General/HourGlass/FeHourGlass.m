...
@property (nonatomic, strong) UIColor *anmationColor;
...
- (instancetype)initWithView:(UIView *)view anmationColor:(UIColor *)color
{
    self = [super init];
    if (self)
    {
        _containerView = view;
        _anmationColor = color ? : [UIColor colorWithRed:0.859 green:0.467 blue:0.412 alpha:1.000];
        [self initCommon];
...
-(void) initCommon
{
    ...
    self.backgroundColor = _containerView.backgroundColor;
...
-(void) initTop
{
    ...
    _topLayer.fillColor = _anmationColor.CGColor;
    _topLayer.strokeColor = _anmationColor.CGColor;
...
-(void) initBottom
{
    ...
    _bottomLayer.fillColor = _anmationColor.CGColor;
    _bottomLayer.strokeColor = _anmationColor.CGColor;
...
-(void) initLine
{
    ...
    _lineLayer.strokeColor = _anmationColor.CGColor;
