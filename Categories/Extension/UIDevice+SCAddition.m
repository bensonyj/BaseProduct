...
+ (NSString *)deviceModel
{
    ...
    if ([platform isEqualToString:@"i386"])         return [UIDevice currentDevice].model;  //Simulator
    if ([platform isEqualToString:@"x86_64"])       return [UIDevice currentDevice].model;  //Simulator，2者都是模拟器
